...
|Derecho|Periodismo|Mercadotecnia|Ingeniería Industrial|Administración de empresas|Contador Público|
|-|-|-|-|-|-
...
### Proyectos, abstracción, modelado... ¡Comunicación!
...
## Bibliografía, enlaces y otras cosas de interés

- [Mis apuntes de DSI](https://github.com/mmasias/DSI-22-23), para picar temas salteados y reflexionar.
- [Referencias varias](https://github.com/mmasias/mmasias/blob/main/referenciasVarias.md) que resultan interesantes de leer para cuestionarnos muchas cosas.
- [Vídeo donde se mencionan los 4 ismos del mundo moderno](https://www.youtube.com/watch?v=e3yV260iPaI) (según el autor, promovidos por la sociedad informática): inmediatismo, fragmentarismo, superficialismo y facilismo (se mencionan en el minuto 4 aprox).
